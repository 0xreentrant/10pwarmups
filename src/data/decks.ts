...
const DECKS: Deck[] = [
  ...
  },
  {
    ...
    moves: [
      ...
      m("Combover", "B"),
      m("Defcon 4", "B"),
      m("Butter Mount Arm Triangle", "B"),
      m("The Impaler Arm Triangle", "B"),
  ...
  },
  {
    ...
    moves: [
      ...
      m("Butterfly Sweep", "B"),
      m("Mounted Marcelotine", "B"),
      m("Hip Bump", "A"),
      m("DM's", "B"),
      m("Flying Guillotine", "B"),
      m("Mounted 1-Arm Guillotine", "B"),
      m("Hip Bump Mount Escape", "A"),
      m("Imanari", "A"),
  ...
  },
  {
    ...
    moves: [
      ...
      m("Berimbolo", "A"),
      m("Trap Arm", "A"),
      m("Rear Naked Choke", "A"),
      m("Leg Press", "B"),
      m("Safe Haven Escape", "B"),
      m("Salvage the Top", "A"),
      m("New Jersey", "B"),
      m("Fire & Flip", "B"),
      m("Gogo Clinch", "B"),
